...
comments:
- author: suncell
  content: 'Z Lesijem imava tajni načrt, da te v petek ukradeva ter odpeljeva na horsa,
    da se pošteno okrepčaš

    . Za sladico pa seveda lahko imaš govejo juhico.'
- author: bjelakrez
  content: ker dan pa je petk? a js pridm u petk? vem sam, da pridm ob 23h. jem pa
    tuki vec kot prevec.
- author: suncell

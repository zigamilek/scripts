...
comments:
- author: suncell
  content: 'A si zmagu pingpong

    ? Kdaj se načrtovano vračata?   Držim pesti, da dobimo še kako slikco za pokušino
    (:'
- author: Brane
  content: Hej! Vesela sva, da se imate dobro in da uzivate. Zeliva, da bi se tako
    imeli do konca. A ze veste, kdaj se vracate? Lepo vaju pozdravljava, mami in ati
- author: P. nitida
  content: 'Tole vajino potovanje je pa res konstantno zanimivo, vse kar opisujeta
    mi je ful všeč.

    Mateja, jutr gremo pa s sošolci na afterkomno - na Aljažev vikend pod Krvavcem,
    ful bo faajn. Aja, pa botaniko sem dobil 10, kljub njegovim grozovitim obljubam
    :-D, ful sem vesel.

    Uživita na polno! Denis'
date_end: '2008-07-25'
date_start: '2008-07-23'
location: Bolivia

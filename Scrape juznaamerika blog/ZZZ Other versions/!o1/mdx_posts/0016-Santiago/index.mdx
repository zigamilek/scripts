...
comments:
- author: suncell
  comment: 'Z Lesijem imava tajni načrt, da te v petek ukradeva ter odpeljeva na horsa,
    da se pošteno okrepčaš

    . Za sladico pa seveda lahko imaš govejo juhico.'
  date: null
- author: bjelakrez
  comment: ker dan pa je petk? a js pridm u petk? vem sam, da pridm ob 23h. jem pa
    tuki vec kot prevec.
  date: null
- author: suncell
  comment: Ja v petek smo prvega, ko se naj bi ti vrnil zvečer domov
  date: null
date_end: null
date_start: null
location: null

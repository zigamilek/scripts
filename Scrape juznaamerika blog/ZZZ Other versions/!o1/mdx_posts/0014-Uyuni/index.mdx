...
comments:
- author: suncell
  comment: 'A si zmagu pingpong

    ? Kdaj se načrtovano vračata?   Držim pesti, da dobimo še kako slikco za pokušino
    (:'
  date: null
- author: Brane
  comment: Hej! Vesela sva, da se imate dobro in da uzivate. Zeliva, da bi se tako
    imeli do konca. A ze veste, kdaj se vracate? Lepo vaju pozdravljava, mami in ati
  date: null
- author: P. nitida
  comment: 'Tole vajino potovanje je pa res konstantno zanimivo, vse kar opisujeta
    mi je ful všeč.
